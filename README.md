...
`cd ch10 && python3 -m pytest -q` prints `36 passed`. Chapter 9's
...
Chapter 10 requires CPython 3.11 or newer and reports `36 passed` on
this initial publication snapshot.
