...
| Listing 9.3 illustrative skill shape | No executable companion source | The listing teaches progressive disclosure as a compact illustrative file shape; it is not maintained companion code |
| Listing 9.4 retrieval flow | `retrieval.py`, `test_retrieval.py` | Provenance, capped selection, and required-source recall stay visible |
